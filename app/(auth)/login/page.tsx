  ...
  return (
    <div className="min-h-screen bg-cream-50 flex flex-col items-center justify-center px-5">
      ...
      <div className="w-full max-w-sm card p-6 fade-up" style={{ animationDelay: '0.05s' }}>
        <h2 className="text-lg font-bold text-gray-900 mb-5">Welcome back</h2>
        ...
        <p className="text-center text-sm text-gray-400 mt-5">
          ...
          <Link href="/signup" className="text-sage-600 font-semibold hover:text-sage-700">Sign up</Link>
        </p>
      </div>
    </div>
  )
